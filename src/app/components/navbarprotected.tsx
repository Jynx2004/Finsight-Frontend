...
const DesktopNav = ({ navItems, visible }: NavbarProps) => {
  ...
  useEffect(() => {
    ...
    if (stored) {
      setUserDetails(JSON.parse(stored) as UserData)
    }
  }, [])
      ...
      <div className='flex items-center gap-2'>
        <AnimatePresence mode='popLayout' initial={false}>
          ...
          >
            ...
            <Box className='hidden md:flex items-center gap-1 px-5 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-full hover:shadow-lg hover:shadow-blue-500/20 transition-all transform hover:scale-105 relative animate-pulse-subtle'>
              <span>Welcome</span>
