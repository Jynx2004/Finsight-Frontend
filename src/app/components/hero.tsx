    ...
    >
      <div className='text-balance relative z-20 mx-auto mb-4 mt-4 max-w-4xl text-center text-4xl font-semibold tracking-tight text-neutral-300 md:text-7xl'>
        <Balancer>
          ...
          >
            <span className='bg-gradient-to-r from-gray-100 via-gray-400 to-gray-100 bg-clip-text text-transparent drop-shadow-md'>
              FINSIGHT
            </span>{' '}
            — Visualize & Secure Your Finances in One Place
          </motion.h2>
        </Balancer>
      </div>
      <motion.p
      ...
      >
        Track all your transactions and explore interactive visualizations to uncover insights that matter.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
